...
namespace Views
{
    public class ProdutoInsert : BaseForm
    {
        ...
        public ProdutoInsert() : base("Inserir Produto")
        {
            ...
            this.btnConfirm = new ButtonForm(this.Controls, "Confirmar", 80,220, this.handleConfirmClick);
            this.btnCancel = new ButtonForm(this.Controls, "Cancelar", 190, 220, this.handleCancelClick);
